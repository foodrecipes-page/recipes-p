...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'p'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-p@main/recipes/<cuisine>/<diet>/<slug>.json
```
